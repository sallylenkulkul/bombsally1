        ...
        <div class="ficha">
            <form action="inserir.php" method="post">
                <div class="opcoes">
                    ...
                    <div class="opc">
                        <input type="radio" name="labios" class="op" value="labios"> &nbsp; Lábios <br>
                        <input type="radio" name="extremidade" class="op" value="extremidade"> &nbsp; Extremidade <br><br>
                    </div>
                    ...
                    <div class="opc">
                        <input type="radio" name="generalizado" class="op1" value="generalizado"> &nbsp; Generalizado <br>
                        <input type="radio" name="localizado" class="op1" value="localizado"> &nbsp; Localizado <br><br>
                    </div>
                    ...
                    <div class="opc">
                        <input type="radio" name="interna" class="op1" value="interna" > &nbsp; Interna <br>
                        <input type="radio" name="externa" class="op1" value="externa"> &nbsp; Externa <br><br>
                    </div>
                    ...
                    <div class="opc">
                        <input type="radio" name="cardiaca" class="op" value="cardiaca"> &nbsp; Cardíaca <br>
                        <input type="radio" name="respiratoria" class="op" value="respiratoria"> &nbsp; Respiratória <br><br>
                    </div>
